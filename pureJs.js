/*
        ...
        Задача со звездочкой: второй парамет теперь не объект, а массив объектов.
        Так же необходимо пересекающиеся ключи. Приоритет  = индекс элемента в массиве
...
/* 
        ...
        Функция принимает два паарметра: 
            -масив с четырмя значениями которые соответствуют количеству монет 
